...
return new class extends Migration
{
    ...
    {
        Schema::create('DOC_ECH', function (Blueprint $table) {
            $table->string('DOC_NUMERO', 10);
            $table->string('DOC_NUMORI', 10)->nullable();
            $table->string('ECH_ORDER', 5);
            $table->string('ECH_NUMERO', 10)->nullable()->index('doc_knum');
            ...
            $table->primary(['DOC_NUMERO', 'ECH_ORDER'], 'doc_pech');
        });
    }
