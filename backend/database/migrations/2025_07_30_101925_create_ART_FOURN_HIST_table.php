...
return new class extends Migration
{
    ...
    {
        Schema::create('ART_FOURN_HIST', function (Blueprint $table) {
            ...
            $table->unique(['ART_CODE', 'ART_GAMME', 'PCF_CODE', 'ART_PFOURN'], 'art_kfhrs2');
            $table->primary(['PCF_CODE', 'ART_CODE', 'ART_GAMME', 'ART_PFOURN'], 'art_pfhrs1');
        });
    }
    ...
    {
        Schema::dropIfExists('ART_FOURN_HIST');
    }
};
