...
return new class extends Migration
{
    ...
    {
        Schema::create('LIG_SERIE', function (Blueprint $table) {
            ...
            $table->index(['DEP_CODE', 'ART_CODE', 'ART_GAMME', 'ART_SERIED', 'ART_SERRES'], 'lig_kserie');
            $table->index(['DOC_NUMERO', 'LIG_NUMERO', 'LIG_SUBNUM', 'ART_NUMERO'], 'lig_ksernu');
            $table->primary(['DOC_NUMERO', 'LIG_NUMERO', 'LIG_SUBNUM', 'ART_SERIED'], 'lig_pserie');
        });
    }
