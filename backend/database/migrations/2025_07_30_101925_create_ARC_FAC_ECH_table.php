...
return new class extends Migration
{
    ...
    {
        Schema::create('ARC_FAC_ECH', function (Blueprint $table) {
            $table->string('FAA_NUMERO', 10);
            $table->string('ECH_ORDER', 5);
            $table->string('ECH_NUMERO', 10)->nullable()->index('afc_knum');
            ...
            $table->primary(['FAA_NUMERO', 'ECH_ORDER'], 'afc_pech');
        });
    }
    ...
    {
        Schema::dropIfExists('ARC_FAC_ECH');
    }
};
