...
return new class extends Migration
{
    ...
    {
        Schema::create('ARC_LIG_INV_LOTS', function (Blueprint $table) {
            ...
            $table->primary(['DOC_NUMERO', 'LIG_NUMERO', 'LIG_SUBNUM', 'LLI_NUMLOT'], 'lia_pnum');
        });
    }
    ...
    {
        Schema::dropIfExists('ARC_LIG_INV_LOTS');
    }
};
