...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('LIGNES', function (Blueprint $table) {
            $table->string('DOC_NUMERO', 10)->index('lig_kdoc');
            $table->string('LIG_NUMERO', 5);
            $table->string('LIG_SUBNUM', 5);
            $table->string('LIG_TYPE', 1)->nullable();
            $table->string('ART_CODE', 30)->nullable()->index('lig_kart');
            ...
            $table->index(['PRJ_CODE', 'DOC_NUMERO'], 'lig_kprj');
            $table->primary(['DOC_NUMERO', 'LIG_NUMERO', 'LIG_SUBNUM'], 'lig_pnum');
        });
    }
