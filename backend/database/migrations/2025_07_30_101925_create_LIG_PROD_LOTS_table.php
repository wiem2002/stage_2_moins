...
return new class extends Migration
{
    ...
    {
        Schema::create('LIG_PROD_LOTS', function (Blueprint $table) {
            ...
            $table->primary(['DOC_NUMERO', 'LIG_NUMERO', 'LIG_SUBNUM', 'LCL_NUMLOT'], 'lcl_pnum');
        });
    }
    ...
    {
        Schema::dropIfExists('LIG_PROD_LOTS');
    }
};
